...
/**
 * 用于接受 core传来的离线消息 用于存储数据库
 * Created by Misnearzhang on 2017/3/13.
 */
@Service("receiverFromCoreServer")
public class ReceiverFromCoreServer {

    private final Logger logger = org.apache.logging.log4j.LogManager.getLogger( ReceiverFromCoreServer.class );
    @Autowired
    ...
    private Gson gson=new Gson();
        public void onMessage(byte[] msg) {
            ...
            if(success){
                pushService.send("success\r\n");
            }else{
                pushService.send("failure\r\n");
            }
        }
}
